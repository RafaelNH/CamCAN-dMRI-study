...
arg1 = path
e.g. Z:/DWI3shells/DWI/Subject1/Rep1/
...
# fit DTI
print 'fiting DKI ...'
dm = dki.DiffusionKurtosisModel(gtab, 'WLS')
...
MK = dtifit.mk(min_kurtosis=-1)
RK = dtifit.rk(min_kurtosis=-1)
AK = dtifit.ak(min_kurtosis=-1)
...
immd = nib.Nifti1Image(MK, affine)
immd.to_filename(outpath+'MK.nii')
imrd = nib.Nifti1Image(RK, affine)
imrd.to_filename(outpath+'RK.nii')
imad = nib.Nifti1Image(AK, affine)
imad.to_filename(outpath+'AK.nii')
